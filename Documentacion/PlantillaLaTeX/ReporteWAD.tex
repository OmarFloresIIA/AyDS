...
\begin{titlepage}
	...
	\vspace{1cm}
	{\huge\Large \color{colorIPN}{Aqu\'i va el nombre de la Materia ejemplo [Web Client and Backend Developmen Framework | Tecnologías para el Desarrollo de Aplicaciones Web]}.\par}
	\vspace{1.5cm}
	...
	\vspace{2cm}
	{\Large\itshape \color{colorIPN}{Alumno: Aquí va el nombre del Alumno ejemplo[Pedro Pica Piedra]}\par} \hfill \break
	{\Large\itshape \color{colorIPN}{mail@mail.com}\par} \hfill \break
	{\Large\itshape \color{colorIPN}{Aquí va el grupo ejemplo [3CM2 | 4BM2]} \par}
	\vfill
